...
import { FolderKanban, Grid, Home, Info, Phone } from 'lucide-react';
...
export default function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/80 dark:bg-navy-950/80 backdrop-blur-lg border-t border-slate-200 dark:border-white/10 pt-2 px-4 pb-2">
